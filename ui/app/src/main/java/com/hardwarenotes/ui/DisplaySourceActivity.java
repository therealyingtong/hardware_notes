...
public class DisplaySourceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String message = "<html><pre style='color:black;background:white;'>\n" +
        ...
        // Capture the layout's WebView and set the string as its text
